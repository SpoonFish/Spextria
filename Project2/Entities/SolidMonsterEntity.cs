...
{
    class SolidMonsterEntity : MonsterEntity
    {
        //public HitboxObject Hitbox;
        protected bool NeedsToJump;
        protected float JumpChargeTime;
        protected float JumpTime;
        protected float _TurnTime;
        //public string CurrentPlanet;
        public SolidMonsterEntity(MyTexture texture, Vector2 position, MonsterStats stats, float speed, float thrust, float weight = 2, List<Attack> attacks = null, HitboxObject customHitbox = null, DataTypes.Intelligence intelligence = DataTypes.Intelligence.Wander, DataTypes.Hostility hostility = DataTypes.Hostility.Neutral) : base(texture, position, stats, speed, thrust, weight, attacks, intelligence, hostility)
        {
        ...
        {
            if (!(Intelligence == DataTypes.Intelligence.Leap))
            {
                NeedsToJump = false;
            }
