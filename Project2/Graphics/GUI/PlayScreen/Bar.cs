        ...
        public void ResetSegments()
        {
            ...
            switch (Style)
            {
                case "enemy_hp":
                    ...
                    {
                        Segments.Add(new BarSegment(segmentPos, Images.UniqueImage(Images.ImageDict["enemy_bar_segment"])));
                ...
                case "player_hp":
                    ...
                    for (int i = 0; i < MaxSegments; i++)
                    {
                        Segments.Add(new BarSegment(segmentPos, Images.UniqueImage(Images.ImageDict["green_player_bar_segment"])));
                        segmentPos.X += SegWidth; //width of a segment
                    }
                    break;
                case "player_se": //rainbow
                    ...
                    for (int i = 0; i < MaxSegments; i++)
                    {
                        Segments.Add(new BarSegment(segmentPos, Images.UniqueImage(Images.ImageDict["se_player_bar_segment"])));
