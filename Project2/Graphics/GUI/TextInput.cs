...
namespace Spextria.Graphics.GUI
{
...

    {
        ...
        public void Update(Point mousePos, ButtonState leftClick, GameTime gameTime, Vector2 graphicsPositionScale = new Vector2())
        {
            ...
            ClickArea.X = (int)(ClickArea.X * graphicsPositionScale.X);
            ClickArea.Y = (int)(ClickArea.Y * graphicsPositionScale.Y);
            ClickArea.Width = (int)(ClickArea.Width * graphicsPositionScale.X);
            ClickArea.Height = (int)(ClickArea.Height * graphicsPositionScale.Y);
        ...
        private void LoadText(string text)
        {
            ...
            {
                case "button":
                    Box = new Panel(Images.ImageDict["button"], new Vector2(Width, MaxHeight), 3);
                    break;
                case "button_hovered":
                    Box = new Panel(Images.ImageDict["button_hovered"], new Vector2(Width, MaxHeight), 3);
                    break;
                case "button_clicked":
                    Box = new Panel(Images.ImageDict["button_clicked"], new Vector2(Width, MaxHeight), 3);
                    break;
                case "button_red":
                    Box = new Panel(Images.ImageDict["button_red"], new Vector2(Width, MaxHeight), 3);
                    break;
                case "button_red_hovered":
                    Box = new Panel(Images.ImageDict["button_red_hovered"], new Vector2(Width, MaxHeight), 3);
                    break;
                case "button_red_clicked":
                    Box = new Panel(Images.ImageDict["button_red_clicked"], new Vector2(Width, MaxHeight), 3);
                    break;
            }
